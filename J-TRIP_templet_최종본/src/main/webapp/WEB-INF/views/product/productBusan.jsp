		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate pb-4">
					<h1 class="mb-3 bread">Busan<br>명소탐방 투어</h1>
					<p>
						<a href="reviewBusan.do" class="btn btn-primary py-2 px-4">Reviews</a>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 tour-wrap mb-5">
					<div class="row">
						<div class="col-md-6 d-flex ftco-animate">
							...
							<form id="form1" method="post" action="reservation.do">
				...
				<div class="pt-5 mt-5">
					...
					<a href="reviewBusan.do" class="btn btn-primary">리뷰페이지 바로가기</a> <br>
					<hr>
					<!-- END comment-list -->
