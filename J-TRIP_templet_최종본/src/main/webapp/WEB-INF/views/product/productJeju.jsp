		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 tour-wrap mb-5">
					<div class="row">
						<div class="col-md-6 d-flex ftco-animate">
							...
							<form name="form3" method="post" action="reservation.do">
						...
						<div class="text py-5">
									...
									<p>
										...
										<a type="button" href="product.do" class="btn btn-secondary">목록보기</a>
									</p>
								</div>
							</form>
						</div>
					...
					<tbody>
						...
						<tr>
							...
							<td class="d-flex">
								<ul>
									<li>[교통] 왕복항공권</li>
									<li>[제세금] 국내공항세, 관광진흥개발기금,<br> 전쟁보험료, 유류할증료
									</li>
								</ul>
								<ul>
						...
						<tr>
							...
							<td class="d-flex">
								<ul>
									...
									<li>[가이드/기사] 가이드/기사 경비 :<br>인당 10,000원 (기사/가이드팁)
									</li>
								</ul>
								<ul>
				...
				<div class="pt-5 mt-5">
					...
					<a href="reviewJeju.do" class="btn btn-primary">리뷰페이지 바로가기</a> <br>
					<hr>
					<!-- END comment-list -->
