		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- DataTales Example -->
					<div class="card shadow mb-4" style="width:1200px;  margin-left:100px; margin-right:50px; margin-top:30px">
						<div class="card-header py-3" >
							<nav class="navbar navbar-expand-lg bg-light"> 
								<div class="container-fluid">
									<a class="navbar-brand" href="reviewMain.do">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Review Page</a>
							...
							<img alt="review" src="imgReview/reviewMain.JPG" style="margin-left: 50px; padding-left:80px; width:1000px;" >
