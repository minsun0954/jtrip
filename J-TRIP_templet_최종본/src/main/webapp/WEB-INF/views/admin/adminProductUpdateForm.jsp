		...
		<div class="container">
			...
			<div
				...
				<h1 class="h5 mb-3 mb-lg-0" style="font-weight: bold; margin-left:auto; margin-right: auto;">
					<a href="../../pages/admin/customers.html" class="text-muted"><i
						class="bi bi-arrow-left-square me-2"></i></a> 여행 상품 수정
				</h1>
			...
			<!-- Main content -->
				...
				<!-- Left side -->
								...
								<form id="frm" action="adminProductUpdate.do" method="post" enctype="multipart/form-data">
				<div class="col-lg-8" >
					<!-- Address -->
					<div class="card mb-4"  >
						<div class="card-body" style="padding: 0px -150px" >
							...
							<span class="select2-selection__arrow" role="presentation"><b
								...
								<label class="form-label">Product Image</label> <input
									type="file" class="form-control" id="file" id="file" value="${vo.productImg }">
							</div>
							<span class="select2-selection__arrow" role="presentation"><b
								role="presentation"></b></span><span class="dropdown-wrapper"
								aria-hidden="true"></span>
				...
				<input type="hidden" id="file" name="file" value="${vo.productImg }">
				<p>					
					<button class="btn btn-primary btn-sm btn-icon-text"
					type="submit">
						<i class="bi bi-save"></i><span class="text">수정</span>
					</button>
					...
					<button class="btn btn-light btn-sm btn-icon-text"
					onclick="location.href='adminProduct.do'">
