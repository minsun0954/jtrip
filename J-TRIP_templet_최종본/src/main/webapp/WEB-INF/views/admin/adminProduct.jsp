...
<body style="margin-top: 80px">
	...
	<script type="text/javascript">
		function subCall(str,data) {
			...
			document.getElementById("nokk").value = id;
			let a = document.getElementById("nokk").value
			console.log(a)
			frm22.action = "adminProductUpdateForm.do"; //수정
